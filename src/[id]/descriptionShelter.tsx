        ...
        <section className="flex flex-col gap-10">
          ...
          <article className="flex flex-col gap-5">
            ...
            <section className="flex flex-col gap-6">
              <div className="flex items-center gap-6 rounded-lg drop-shadow-2xl p-5 justify-center bg-gray-100">
                <CircleCheck size={30} className="text-primary" />
                <p className="text-2xl">Aceita animais</p>
              </div>
              <div className="flex items-center gap-6 rounded-lg drop-shadow-2xl p-5 justify-center bg-gray-100">
                <Bed size={30} className="text-primary" />
                <p className="text-2xl">Que bom que você pode ajudar!</p>
              </div>
            </section>
          </article>
